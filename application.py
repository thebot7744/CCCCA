...
def signupComplete():
    ...
    try:
        db.execute(
            "INSERT INTO AccountInfo (email, username, firstname, lastname, password) VALUES (:email, :username, :firstname, :lastname, :password)",
...
def loginComplete():
    ...
    checkPassword = db.execute("SELECT * FROM AccountInfo WHERE password = :password",
